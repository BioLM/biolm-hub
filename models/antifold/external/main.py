...
from antifold.antiscripts import (
    ...
    sample_from_df_logits_modified,
    write_fasta_to_dir,
    visualize_mutations,
)
...
def sample_pdbs(
    ...
    print("Using modified main script")
