...
> **Note on action verb naming**: Biotite uses the catalog's standard action verbs `generate` and
...
> naming follows the catalog's action-verb contract; the docs below clarify what each action does.
