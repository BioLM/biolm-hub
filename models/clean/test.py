...
test_clean_integration = generate_tests_from_suite(test_suite, test_type="integration")

# Generate deployment tests (marked with @pytest.mark.deployment)
test_clean_deployment = generate_tests_from_suite(test_suite, test_type="deployment")
