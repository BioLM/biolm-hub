...
3. **Downloads weights** to `/model-store/` during build
...
```json
{
    ...
    "r2_prefix": "model-store/esmc/v1/esmc_300m",
    "file_count": 15,
    "manifest_uploaded": true,
    "manifest_key": "model-store/esmc/v1/esmc_300m/.r2_manifest.json"
}
```
...
R2Utils.upload_to_r2_atomic(
    ...
    r2_prefix='model-store/new_model/v1/base'
)
"
```
...
```bash
# Check R2 contents
bm r2 ls | grep "model-store/esmc"
...
python -c "
from models.commons.storage.r2_utils import R2Utils
exists = R2Utils.check_r2_cache_exists('model-store/esmc/v1/esmc_300m')
