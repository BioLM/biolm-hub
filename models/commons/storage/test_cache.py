...
# This whole module exercises the live caching layer: the short-term cache is a
# modal.Dict (needs a Modal token) and the R2 tests need R2 credentials. It is an
# integration suite, excluded from the creds-free unit run.
