...
def execute_integration_test_case(
    ...
    # 4. Execute the remote method with retry logic (retry transient Modal infrastructure errors)
    MAX_ATTEMPTS = 2
    ...
    for attempt in range(MAX_ATTEMPTS):
        try:
            ...
            # Stream Modal build/run logs to the console during the remote call
