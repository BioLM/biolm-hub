...
*See also: [MODEL.md](MODEL.md) for technical deep-dive | [BIOLOGY.md](BIOLOGY.md) for biological context | this model's [docs page](https://biolm.github.io/biolm-hub/models/{model_name}/) | machine-readable knowledge graph: [`comparison.yaml`](comparison.yaml) (when-to-use / alternatives) + [`sources.yaml`](sources.yaml) (license / papers)*
