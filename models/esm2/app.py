...
image = (
    image.apt_install("procps")  # process utilities (ps) used by the Modal runtime
...
class ESM2Model(ModelMixinSnap):
    ...
    def _encode_forward_pass(  # noqa: C901
        ...
        # Branching is inherent here: single-pass batch inference dispatch over layers/outputs.
...
if __name__ == "__main__":
    ...
    Usage:
        ...
        # Force deploy to your configured Modal environment:
