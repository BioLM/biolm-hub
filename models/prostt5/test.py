...
def _validate_prostt5_generate(
        ...
        VariantTestMapping(
            ...
            test_cases=[
                ActionTestCase(
                    ...
                    validator=_validate_prostt5_generate,
                ),
            ],
        ),
...
test_prostt5_integration = generate_tests_from_suite(
    test_suite, test_type="integration"
)

# Generate deployment tests (marked with @pytest.mark.deployment)
test_prostt5_deployment = generate_tests_from_suite(test_suite, test_type="deployment")
